...
namespace BAMTS.Internal
{
    ...
    /// </summary>
    /// <remarks></remarks>
    public class SQLServerAccessMethods : IDisposable
    {
        ...
        public SQLServerAccessMethods(string connectionString)
        {
        ...
        /// <param name="outputExecuteLog">処理ログ出力指定</param>
        public SQLServerAccessMethods(string connectionString, int commandTimeout)
        ...
        public DbResultState Open(bool forceOpen)
        {
            try
            {
            ...
            {
                string message = string.Format("データベースのオープンに失敗しました。(SqlException) Message:[{0}]/ErrorNo:[{1}]", ex.Message, ex.Number);
                this.WriteProcessLog(message);
                throw new Exception(message, ex);
            }
        }
        public DbResultState Open() { return this.Open(false); }
        /// <summary>
        /// DBクローズ
        /// </summary>
        /// <returns>処理結果ステータス</returns>
        ...
        public DbResultState Close()
        {
            ...
            {
                return DbResultState.CannotClose;
        ...
        /// <remarks></remarks>
        public DataTable GetDataTable(string sql, bool useTransaction)
        {
        ...
        /// <returns>DataTableオブジェクト</returns>
        /// <remarks></remarks>
        public DataTable GetDataTable(SqlCommand command, bool useTransaction)
        {
            DataTable aDataTable = new DataTable();
            try
            {
        ...
        /// <remarks></remarks>
        public DataSet GetDataSet(SqlCommand command, bool useTransaction)
        {
            ...
            {
                string message = string.Format("データベース：データセットの取得に失敗しました。(SqlException) Message:[{0}]/ErrorNo:[{1}]", ex.Message, ex.Number);
                this.WriteProcessLog(message);
                throw new Exception(message, ex);
            }
        }
        ...
        /// <remarks></remarks>
        public SqlDataReader GetDataReader(string sql, bool useTransaction)
        {
        ...
        /// <returns>SqlDataReaderオブジェクト</returns>
        /// <remarks></remarks>
        public SqlDataReader GetDataReader(SqlCommand command, bool useTransaction)
        {
            SqlDataReader ret = default(SqlDataReader);
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public int ExecuteSQL(SqlCommand command, bool useTransaction)
        {
            int ret = 0;
        ...
        /// <returns>影響を受けた行数。-1はエラー。</returns>
        /// <remarks></remarks>
        public int ExecuteStored(string sql, bool useTransaction)
        {
            int ret = 0;
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public DbCommand GetCommand(bool useTransaction)
        {
            try
            {
